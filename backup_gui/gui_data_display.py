from separation_indexes_calculation import empaticaParser, timingsParser, SAMPLE_RATES, panasParser
...
class MainWindow(tk.Frame):
    ...
    def choose_mode(self, *args):
        ...
        self.third_button_text.set("With actigraphy detrended")
        ...
        self.third_button['command'] = lambda: self.launch_new_window(*args, mode = "detrended")
